; No Man's Sky Redirector v0.9 by CheatFreak
...
if (depotspath = "")
{
	...
	depotspath := SubStr(NMSInstall, 1, lastSlash - 1)
	depotspath := depotspath . "\Old Versions"
}
